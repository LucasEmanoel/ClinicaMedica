...
public class EspecialidadeDao extends DaoImpl<Especialidade> implements EspecialidadeDaoInterface {
	...
	public Especialidade encontarPorRqe(Long rqe) {
		...
		String consulta ="SELECT E FROM Especialidade AS E WHERE E.especialidade_rqe = :rqe";
		
		TypedQuery<Especialidade> query = 
				manager.createQuery(consulta, Especialidade.class);
